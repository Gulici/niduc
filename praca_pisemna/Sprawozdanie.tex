...
\lstdefinelanguage{Verilog}{
    keywords={
        ...
        for, while, generate, endgenerate,
        assign, parameter, localparam,
        initial, posedge, negedge
    },
    keywordstyle=\color{blue}\bfseries,
    sensitive=true,
    comment=[l]{//},
...
\ifpdf
 ...
 \usepackage{hyperxmp}  % <--- PRZENIESIONE TUTAJ
...
Przedmiot: & {\bfseries \@specjalnosc}\\
\end{tabular}\\[1.3cm]
}
{\vskip 29pt\centering{\fontsize{24pt}{26pt}\selectfont%
{\fontsize{26pt}{28pt}\selectfont S}PRAWOZDANIE Z {\fontsize{26pt}{24pt}\selectfont P}ROJEKTU\\[7pt]
}}
	\vfill
{\centering
		{\fontsize{14pt}{16pt}\selectfont Prowadzący}\\[2mm] 
...
\title{Jednostka arytmetyczna z detekcją błędów} % INFO: tytuł pracy w języku polskim 
\titleShort{Jednostka arytmetyczna z detekcją błędów}  % INFO: krótki tytuł pracy (do zamieszczenia w stopce, sklejony z imieniem i nazwiskiem autora nie powinien zająć więcej niż jedną linijkę)
\author{Krzysztof Czerniachowicz}  % INFO: imię i nazwisko autora
...
\specjalnosc{Niezawodność i Diagnostyka układów cyfrowych} % INFO: nazwa specjalności
\promotor{Dr hab inż. Stanisław Piestrak prof. uczelni} % INFO: dane promotora 
